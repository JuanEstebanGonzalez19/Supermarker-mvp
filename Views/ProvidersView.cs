    ...
    public partial class ProvidersView : Form, IProvidersView
    {
        ...
        private void AssociateAndRaiseViewEvents()
        {
            ...
            BtnNew.Click += delegate
            {
                ...
                tabPageProvidersDetail.Text = "Add New Providers";//cambia el titulo de la pestaña
            };
            BtnEdit.Click += delegate
            {
                ...
                tabControl1.TabPages.Remove(tabPageProvidersList);
                tabControl1.TabPages.Add(tabPageProvidersDetail);
                tabPageProvidersDetail.Text = "Edit Providers";//cambia el titulo de la pestaña
            };
            BtnDelete.Click += delegate
            {
                var result = MessageBox.Show(
                    "Are you sure you want to delete the select Providers",
                    "WARNING",
